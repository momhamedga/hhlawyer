...
-- CreateEnum
CREATE TYPE "ConsultationStatus" AS ENUM ('PENDING', 'CONFIRMED', 'RESCHEDULED', 'COMPLETED', 'CANCELLED');
...
-- CreateIndex
CREATE UNIQUE INDEX "Consultation_referenceNumber_key" ON "Consultation"("referenceNumber");
