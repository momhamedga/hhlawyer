...
export const getAdminServices=(filters:AdminServicesFilters)=>apiFetch<AdminServicesListResponse>(`/admin/services?${queryString(filters)}`,{credentials:"include"});
export const getAdminService=(id:string)=>apiFetch<AdminServiceDetail>(`/admin/services/${encodeURIComponent(id)}`,{credentials:"include"});
