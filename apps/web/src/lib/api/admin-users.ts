...
export const getAdminUsers=(filters:AdminUsersFilters)=>apiFetch<AdminUsersListResponse>(`/admin/users?${qs(filters)}`,{credentials:"include"});
export const getAdminUser=(id:string)=>apiFetch<AdminUserDetail>(`/admin/users/${encodeURIComponent(id)}`,{credentials:"include"});
