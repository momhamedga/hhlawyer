...
export const BioSection = () => {
  ...
  const t = messages[locale].public.about;
  return <section className="relative w-full py-20 md:py-40 flex flex-col items-center">
    ...
    <div className="w-full max-w-5xl px-6 md:px-10 space-y-20 md:space-y-32">
      ...
      ">
        <StatItem label={t.bioStats[0]} value="500+" index={1} />
        <StatItem label={t.bioStats[1]} value="15" index={2} />
        <StatItem label={t.bioStats[2]} value="03" index={3} />
      </div>
    </div>
  </section>;
};
