...
export const Hero: React.FC = () => {
  ...
  const t = messages[locale].public.home;
  return (
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <h1 className="text-5xl md:text-7xl lg:text-8xl font-black text-white leading-tight mb-8 tracking-tight">
              {t.heroTitleStart} <br className="hidden md:block" />
              <span className="text-transparent bg-clip-text bg-linear-to-r from-gold via-white to-gold animate-gradient-x">{t.heroTitleAccent}</span>
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-5 justify-center lg:justify-start">
              ...
              >
                <span className="relative z-10 text-royal-charcoal font-black text-lg">{t.heroBook}</span>
          ...
          >
            ...
            <div className="relative w-80 h-112 md:w-112 md:h-144 lg:w-128 lg:h-160 group">
              ...
              >
                ...
                <p className="text-white/80 text-[10px] uppercase font-bold tracking-[0.3em] mt-2">{t.yearsLeadership}</p>
              </motion.div>
            </div>
          </motion.div>
