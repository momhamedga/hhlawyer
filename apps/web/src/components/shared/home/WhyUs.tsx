  ...
  return (
    <section id="why-us" className="relative py-24 md:py-32 overflow-hidden bg-royal-charcoal border-t border-white/5">
      <div className="container mx-auto px-5 md:px-6 relative z-10">
        ...
        {/* Header Section */}
        <div className="flex flex-col items-center lg:items-end mb-16 md:mb-20 text-center lg:text-start w-full gap-6">
          <div className="max-w-2xl">
            ...
            >
              {t.whyTitleStart} <span className="text-transparent bg-clip-text bg-linear-to-r from-gold via-white to-gold animate-gradient-x">{t.whyTitleAccent}</span>
            </motion.h3>
          </div>
        </div>
