  ...
  return (
    <section id="services" className="relative py-20 md:py-32 overflow-hidden bg-royal-charcoal">
      <div className="container mx-auto px-5 md:px-6 relative z-10">
        ...
        {/* Header Section */}
        <div className="flex flex-col items-start mb-12 md:mb-20 text-start w-full">
          <motion.h2 
          ...
          >
            {t.practiceTitle} <span className="text-white/20 italic">{t.practiceAccent}</span>
          </motion.h3>
        </div>
