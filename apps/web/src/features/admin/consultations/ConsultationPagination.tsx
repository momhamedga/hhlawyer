...
export function ConsultationPagination({ locale, page, totalPages, onPageChange }: { locale: Locale; page: number; totalPages: number; onPageChange: (page: number) => void }) {
  ...
  return (
    <nav aria-label={copy.pageSummary(page, totalPages)} className={styles.pagination}>
